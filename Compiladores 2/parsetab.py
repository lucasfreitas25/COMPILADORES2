...
_lr_productions = [
  ...
  ('CMD -> PRINT LPAR EXPRESSAO RPAR','CMD',4,'p_cmd','teste.py',217),
  ('CMD -> ID RESTO_IDENT','CMD',2,'p_cmd','teste.py',218),
  ('PFALSA -> ELSE LCBRA CMDS RCBRA','PFALSA',4,'p_pfalsa','teste.py',232),
  ('PFALSA -> empty','PFALSA',1,'p_pfalsa','teste.py',233),
  ('RESTO_IDENT -> ASSIGMENT EXP_IDENT','RESTO_IDENT',2,'p_resto_ident','teste.py',244),
  ('RESTO_IDENT -> LPAR LISTA_ARG RPAR','RESTO_IDENT',3,'p_resto_ident','teste.py',245),
  ('CONDICAO -> EXPRESSAO RELACAO EXPRESSAO','CONDICAO',3,'p_condicao','teste.py',259),
  ('RELACAO -> IGUAL','RELACAO',1,'p_relacao','teste.py',281),
  ('RELACAO -> DIF','RELACAO',1,'p_relacao','teste.py',282),
  ('RELACAO -> MAI','RELACAO',1,'p_relacao','teste.py',283),
  ('RELACAO -> MEN','RELACAO',1,'p_relacao','teste.py',284),
  ('RELACAO -> MAI_IGUAL','RELACAO',1,'p_relacao','teste.py',285),
  ('RELACAO -> MEN_IGUAL','RELACAO',1,'p_relacao','teste.py',286),
  ('LISTA_ARG -> ARGUMENTOS','LISTA_ARG',1,'p_lista_arg','teste.py',292),
  ('LISTA_ARG -> empty','LISTA_ARG',1,'p_lista_arg','teste.py',293),
  ('ARGUMENTOS -> ID MAIS_IDENT','ARGUMENTOS',2,'p_argumentos','teste.py',300),
  ('MAIS_IDENT -> VIRGU ARGUMENTOS','MAIS_IDENT',2,'p_mais_ident','teste.py',305),
  ('MAIS_IDENT -> empty','MAIS_IDENT',1,'p_mais_ident','teste.py',306),
  ('EXP_IDENT -> EXPRESSAO','EXP_IDENT',1,'p_exp_ident','teste.py',311),
  ('EXP_IDENT -> LERDOUBLE LPAR RPAR','EXP_IDENT',3,'p_exp_ident','teste.py',312),
  ('EXPRESSAO -> TERMO OUTROS_TERMOS','EXPRESSAO',2,'p_expressao','teste.py',321),
  ('TERMO -> OP_UN FATOR MAIS_FATORES','TERMO',3,'p_termo','teste.py',331),
  ('OP_UN -> MENOS','OP_UN',1,'p_op_un','teste.py',349),
  ('OP_UN -> empty','OP_UN',1,'p_op_un','teste.py',350),
  ('FATOR -> ID','FATOR',1,'p_fator','teste.py',355),
  ('FATOR -> NUMBER','FATOR',1,'p_fator','teste.py',356),
  ('FATOR -> LPAR EXPRESSAO RPAR','FATOR',3,'p_fator','teste.py',357),
  ('OUTROS_TERMOS -> OP_AD TERMO OUTROS_TERMOS','OUTROS_TERMOS',3,'p_outros_termos','teste.py',377),
  ('OUTROS_TERMOS -> empty','OUTROS_TERMOS',1,'p_outros_termos','teste.py',378),
  ('OP_AD -> SUM','OP_AD',1,'p_op_ad','teste.py',397),
  ('OP_AD -> MENOS','OP_AD',1,'p_op_ad','teste.py',398),
  ('MAIS_FATORES -> OP_MUL FATOR MAIS_FATORES','MAIS_FATORES',3,'p_mais_fatores','teste.py',403),
  ('MAIS_FATORES -> empty','MAIS_FATORES',1,'p_mais_fatores','teste.py',404),
  ('OP_MUL -> MUL','OP_MUL',1,'p_op_mul','teste.py',426),
  ('OP_MUL -> DIVI','OP_MUL',1,'p_op_mul','teste.py',427),
  ('empty -> <empty>','empty',0,'p_empty','teste.py',432),
]
